...
{
    public partial class ChangeAmountOfItem : Form
    {
        private readonly int _numberwas;
        private readonly string _itemId;
        private Point? _old;
        public ChangeAmountOfItem(int numberWas, string itemId)
        {
            InitializeComponent();
            _itemId = itemId;
        ...
        private void bApply_Click(object sender, EventArgs e)
        {
            ...
            {
                DataBaseClass.Instancedb().ChangeItemAmount(_itemId, (int)numUpDNumber.Value);
                Close();
            }
            else
            {
