...
namespace Boom_Manager_Project
{
    public partial class TimeTester : Form
    {
        ...
        {
            return time > TimeSpan.FromHours(1) && time < TimeSpan.FromHours(5);
        }
